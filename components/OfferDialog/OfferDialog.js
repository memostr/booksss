...
function OfferDialog({ product, showDialog, closeDialog }) {
  ...
  const offer = () => {
    ...
    // Seçilen teklif miktarını belirle
    let selectedOfferPrice = 0;
    switch (selectedOffer) {
      case 0:
        selectedOfferPrice = product.price * 0.2;
        break;
      case 1:
        selectedOfferPrice = product.price * 0.3;
        break;
      case 2:
        selectedOfferPrice = product.price * 0.4;
        break;
      default:
        selectedOfferPrice = parseFloat(customPrice);
        break;
    }
  
    // Teklif verme işlemini gerçekleştir veya teklif miktarını göster
    console.log("Teklif Miktarı:", selectedOfferPrice);
